...
class AppConfig {
  ...
  //?
  static bool get VISUAL_FLOSS_ENABLED =>
      dotenv.env['VISUAL_FLOSS_ENABLED'] == 'true';
  static bool get ECHO_GAMES_LAB_ENABLED =>
      dotenv.env['ECHO_GAMES_LAB_ENABLED'] == 'true';
  static bool get EXCEEDIUM_GAMES_ENABLED =>
      dotenv.env['EXCEEDIUM_GAMES_ENABLED'] == 'true';
  static bool get SIGIL_GAMES_ENABLED =>
      dotenv.env['SIGIL_GAMES_ENABLED'] == 'true';
  static bool get IZ_HAZARD_ENABLED =>
      dotenv.env['IZ_HAZARD_ENABLED'] == 'true';
  static bool get FLESH_INSANE_TEAM_ENABLED =>
      dotenv.env['FLESH_INSANE_TEAM_ENABLED'] == 'true';
  ...
  static List<String> get enabledStudios {
    ...
    static GameModel get incelThread => GameModel(
    gameName: 'Incelthread',
    description: AppAssets.incelthread_description,
    gamePath: VISUAL_FLOSS_GAME_PATH,
    processName: VISUAL_FLOSS_PROCESS,
    qrAssetPath: AppAssets.visual_floss_qr,
    videoPath: AppAssets.visual_floss_video_1,
    imagesList: [
    ],
  );
  ...
  static GameModel get theSacredMemory => GameModel(
    ...
    description: AppAssets.the_sacred_memory,
    gamePath: VISUAL_FLOSS_GAME_PATH,
    processName: VISUAL_FLOSS_PROCESS,
    qrAssetPath: AppAssets.visual_floss_qr,
    videoPath: '',
    imagesList: [
      ...
      AppAssets.visual_floss_src6,
      AppAssets.visual_floss_src7,
      AppAssets.visual_floss_src8,
      AppAssets.visual_floss_src9,
    ],
  );

  static GameModel get theDayInALifeOfADayfly => GameModel(
    gameName: 'A Day in a Life of a Dayfly',
    description: AppAssets.the_day_in_a_life_of_a_dayfly_description,
    gamePath: VISUAL_FLOSS_GAME_PATH,
    processName: VISUAL_FLOSS_PROCESS,
    qrAssetPath: AppAssets.visual_floss_qr,
    videoPath: AppAssets.visual_floss_video_2,
    imagesList: [
    ],
  );

   static GameModel get raw => GameModel(
    gameName: 'R/A\\W',
    description: AppAssets.raw_description,
    gamePath: VISUAL_FLOSS_GAME_PATH,
    processName: VISUAL_FLOSS_PROCESS,
    qrAssetPath: AppAssets.visual_floss_qr,
    videoPath: AppAssets.visual_floss_video_3,
    imagesList: [
    ],
  );

   static GameModel get nareTheGreatChainOfBeing => GameModel(
    gameName: 'NA-Re The Great Chain of Being',
    description: AppAssets.nare_desription,
    gamePath: VISUAL_FLOSS_GAME_PATH,
    processName: VISUAL_FLOSS_PROCESS,
    qrAssetPath: AppAssets.visual_floss_qr,
    videoPath: AppAssets.visual_floss_video_4,
    imagesList: [
    ],
  );
  ...
  static String get VISUAL_FLOSS_PROCESS =>
      dotenv.env['VISUAL_FLOSS_PROCESS'] ?? 'CalculatorApp.exe';
  static String get ECHO_GAMES_LAB_PROCESS =>
      dotenv.env['ECHO_GAMES_LAB_PROCESS'] ?? 'CalculatorApp.exe';
  static String get EXCEEDIUM_GAMES_PROCESS =>
      dotenv.env['EXCEEDIUM_GAMES_PROCESS'] ?? 'CalculatorApp.exe';
  static String get SIGIL_GAMES_PROCESS =>
      dotenv.env['SIGIL_GAMES_PROCESS'] ?? 'CalculatorApp.exe';
  static String get IZ_HAZARD_PROCESS =>
      dotenv.env['IZ_HAZARD_PROCESS'] ?? 'CalculatorApp.exe';
  static String get FLESH_INSANE_TEAM_PROCESS =>
      dotenv.env['FLESH_INSANE_TEAM_PROCESS'] ?? 'CalculatorApp.exe';
  static String get EMOSDK_PROCESS =>
      dotenv.env['EMOSDK_PROCESS'] ?? 'CalculatorApp.exe';

  static String get VISUAL_FLOSS_GAME_PATH =>
      dotenv.env['VISUAL_FLOSS_GAME_PATH'] ?? 'calc.exe';
  static String get ECHO_GAMES_LAB_GAME_PATH =>
      dotenv.env['ECHO_GAMES_LAB_GAME_PATH'] ?? 'calc.exe';
  static String get EXCEEDIUM_GAMES_GAME_PATH =>
      dotenv.env['EXCEEDIUM_GAMES_GAME_PATH'] ?? 'calc.exe';
  static String get SIGIL_GAMES_GAME_PATH =>
      dotenv.env['SIGIL_GAMES_GAME_PATH'] ?? 'calc.exe';
  static String get IZ_HAZARD_GAME_PATH =>
      dotenv.env['IZ_HAZARD_GAME_PATH'] ?? 'calc.exe';
  static String get FLESH_INSANE_TEAM_GAME_PATH =>
      dotenv.env['FLESH_INSANE_TEAM_GAME_PATH'] ?? 'calc.exe';
  static String get EMOSDK_GAME_PATH =>
  ...
  static StudioModel get exceediumGames =>
      StudioModel(studioName: 'Exceedium Games', games: [shakeIt]);

  static StudioModel get sigilGames =>
  ...
  static StudioModel get emoSDK =>
      StudioModel(studioName: 'EmoSDK', games: [emoSDKGame]);
